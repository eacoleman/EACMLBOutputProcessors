...
//=========  (Wed Aug 19 19:15:07 2015) by ROOT version6.02/05
   ...
   pullFit1004->SetChisquare(1611.841);
   ...
   pullFit1004->SetParameter(0,-2.576359);
   pullFit1004->SetParError(0,0.0294395);
